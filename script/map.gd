...
func _on_action_pressed(action_id: String):
	...
	match action_id:
		   ...
		   "archive":
				 LoadingManager.set_target_scene("res://scenes/archive.tscn")
				 await Transition.fade_out()  
				 get_tree().change_scene_to_file("res://scenes/loading_screen.tscn")  # 2. pindah
				 await Transition.fade_in()  
		   ...
		   "tutorial":
				 LoadingManager.set_target_scene("res://scenes/tutorial.tscn")
				 await Transition.fade_out()  
				 get_tree().change_scene_to_file("res://scenes/loading_screen.tscn")  # 2. pindah
				 await Transition.fade_in()
				
		   "endless":
				 LoadingManager.set_target_scene("res://scenes/endless_menu.tscn")
				 await Transition.fade_out()  
				 get_tree().change_scene_to_file("res://scenes/loading_screen.tscn")  # 2. pindah
				 await Transition.fade_in()  
