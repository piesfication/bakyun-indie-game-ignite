extends "res://scripts/gameplay/levels/main.gd"
...
@onready var baku_smile = get_node_or_null("CanvasLayer/BakuYunaExpression/BakuSmile")
@onready var baku_shock = get_node_or_null("CanvasLayer/BakuYunaExpression/BakuShock")
@onready var yuna_smile = get_node_or_null("CanvasLayer/BakuYunaExpression/YunaSmile")
@onready var yuna_shock = get_node_or_null("CanvasLayer/BakuYunaExpression/YunaShock")

@onready var alpha = get_node_or_null("CanvasLayer/BossAnim")
@onready var alphabody = get_node_or_null("CanvasLayer/BossAnim/Base")
...
func on_dialogic_signal(arg: String):
	...
	if (arg == "bakumono_level") :
		LoadingManager.set_target_scene("res://scenes/gameplay/levels/main_bakumono.tscn")
		await Transition.fade_out()
		get_tree().change_scene_to_file("res://scenes/core/loading_screen.tscn")
		await Transition.fade_in() # fade out
		
	if (arg == "yuokai_level") :
		LoadingManager.set_target_scene("res://scenes/gameplay/levels/main_yuokai.tscn")
		await Transition.fade_out()
		get_tree().change_scene_to_file("res://scenes/core/loading_screen.tscn")
		await Transition.fade_in() # fade out
